...
namespace TestJ
{
    ...
    {
        private Transform _myTransform; // 보스의 트랜트폼
        ...
        private void Start()
        {
            ...
            bossRotation = bossRotatePivot.transform.position;
            myPos = _myTransform.position; 
        }
        ...
        private void CheckDistance()
        {
            ...
            float d = Vector3.Distance(playerPos, myPos);
            result = Mathf.Sqrt(d);
        }
        ...
        private void Move()
        {
            ...
            if (result > maxDistance)
            {
                ...
                Debug.Log($"Target out of range! Tracking down... Found target at: {playerPos}");
                ...
                Vector3 targetPos = new Vector3(myPos.x - playerPos.x, 0f, myPos.z - playerPos.z);
                targetPos.Normalize();
                ...
                // 
                Vector3 targetDir = Vector3.MoveTowards(myPos, targetPos, moveSpeed * Time.deltaTime);
                // https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Vector3.MoveTowards.html
                myPos -= moveSpeed * Time.deltaTime * targetDir; // MoveTowards()를 사용해서 나온 값의 용도를 착각했기 때문에 문제 발생
                Debug.Log("???");
            }
        }
    }
